...
docker network ls will list all of the docker networks on your machine
    ...
    by default.  If you do not name this network in your docker file the name becomes
    the name of the directory docker-compose.yml is in with "_default" appended.
